...
def run_batch():
    ...
    return {"sources":len(results),"rows_inserted":total,"results":[{"source":r.source,"rows":len(r.rows),"error":r.error,"latency_ms":round(r.latency_ms or 0,2)} for r in results]}
