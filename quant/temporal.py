    ...
    *,
    ...
    while cursor + test_size <= len(ordered):
        ...
        if train and test:
            ...
            # The embargo applies to later folds; samples inside it cannot enter a future train set.
            next_cursor = cursor + test_size
            while next_cursor < len(ordered) and ordered[next_cursor].event_time < embargo_end:
                next_cursor += 1
